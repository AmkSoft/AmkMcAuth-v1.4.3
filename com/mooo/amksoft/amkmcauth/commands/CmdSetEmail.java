        ...
        if (cmd.getName().equalsIgnoreCase("setemail")) {        	
            ...
            if (args.length < 1) {
            	...
            	if(ap.getEmailAddress().contains("#")) {
            		cs.sendMessage(Language.EMAIL_ADDRESS.toString() + " " + ap.getEmailAddress().replace("#", "") + " " + Language.NOTCONFIRMD.toString());
            	} else {
            		cs.sendMessage(Language.CURRENT.toString() + " " + Language.EMAIL_ADDRESS.toString() + ": " + ap.getEmailAddress().replace("#", ""));                    		
            	}
                return false;
            }
