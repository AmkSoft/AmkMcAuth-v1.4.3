...
public class Config {
    ...
    public void reloadConfigurationOld() {
        this.plugin.reloadConfig(); 
        final FileConfiguration c = this.plugin.getConfig();
        ...
        if(c.isSet("login.invisible_mode")) invisibleMode = c.getBoolean("login.invisible_mode");

        adventureMode = c.getBoolean("login.adventure_mode");
        teleportToSpawn = c.getBoolean("login.teleport_to_spawn");
        if(c.isSet("login.tpToSpawnTrue.useSpawnAtLocation"))   useSpawnAt = c.getBoolean("login.tpToSpawnTrue.useSpawnAtLocation");  
        if(c.isSet("login.tpToSpawnTrue.teleportToSpawnWorld")) spawnWorld = c.getString("login.tpToSpawnTrue.teleportToSpawnWorld");
        if(c.isSet("login.tpToSpawnTrue.spawnAtLocationX"))     spawnWorldX = c.getLong("login.tpToSpawnTrue.spawnAtLocationX");
        if(c.isSet("login.tpToSpawnTrue.spawnAtLocationY"))     spawnWorldY = c.getLong("login.tpToSpawnTrue.spawnAtLocationY");
        if(c.isSet("login.tpToSpawnTrue.spawnAtLocationZ"))     spawnWorldZ = c.getLong("login.tpToSpawnTrue.spawnAtLocationZ");
        ...
        if(c.isSet("saving.remove_inactive_after")) removeAfterDays = c.getInt("saving.remove_inactive_after");
